...
describe('CarService Suite Tests', () => {
    ...
    it('given a carCategory, cutomer and numberOfDays it should calculate final amount in real', async() => {
        ...
        //não depender de dados externos! ou estáticos
        sandbox.stub(
            carService,
            "taxesBasedOnAge"
    ...
    it('given a customer and a car category is should return a transaction receipt', async () => {
        ...
        // age: 20, tax: 1.1, cartegoryPrice: 37.6
